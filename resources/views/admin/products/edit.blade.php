...
<div class="max-w-3xl mx-auto">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <div>
            ...
            <p class="text-sm text-white/50 mt-1">Edit informasi produk {{ $product->name }}</p>
        </div>
                ...
                <div class="rounded-xl bg-white/5 p-6 border border-green-500/20">
                    ...
                    <div class="flex items-center gap-6">
                        @if($imageExists)
                            ...
                            <div class="flex-1">
                                <p class="text-sm text-white/50 break-all">{{ basename($product->image) }}</p>
                        ...
                        @else
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-white/40 mt-1">{{ $product->image }}</p>
                                </div>
                            </div>
                        @endif
                    </div>
